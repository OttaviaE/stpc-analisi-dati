...
La lezione del 24 settembre ci sarà ma saremo in aula 6 e 7 (una delle due aule sarà connessa). 

La lezione del 5 novembre è da confermare. Nel caso non venisse fatta, sarà recuperata il 10 o 11 dicembre

Esiste la possibilità che vengano cancellate altre lezioni a causa delle lauree. Controllate sempre easyroom.
:::


### 

Tutto il materiale del corso sarà presente sulla piattaforma Moodle e sul sito disponibile a questo link: 

<https://ottaviae.github.io/stpc-analisi-dati/>

Ricevimento: Va concordato via mail (ottavia.epifania@unitn.it), può essere online o in presenza
...
Preferisco che vengano rispettati gli orari di lezioni e vorrei evitare il via vai continuo di gente. 

Preferisco ancora di più che le persone non interessate escano senza disturbare quelle che provano a seguire quello che dico.

Se non capite qualcosa, fermatemi subito, rispiego la stessa cosa anche fino alla nausea.
:::
...
Durante il corso verranno effetuate due esercitazioni che faranno punteggio per l'esame. 
...
Ogni esercitazione permette di guadagnare 1.5 punti, da sommare al punteggio raggiunto all'esame. 
...
A \color{blue}[questo link](https://arca-dpss.github.io/shine-with-quarto/) \normalcolor trovate maggiori informazioni su quarto e una guida veloce sul suo funzionamento 
...
2. Dentro al progetto R: 
  ...
  * Creare uno script R e salvarlo nella cartella del progetto (`script.R`)
