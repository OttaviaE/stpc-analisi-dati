...
#'
#' @param limIX Limite inferiore del supporto della distribuzione

#' @param limSX Limite superiore del supporto della distribuzione

#' @param media Media della distribuzione

#' @param ds Deviazione standard

#' @param quantX Quantili della distribuzione che si vogliono visualizzare
#'
#' @returns plot
#' 
...
#' @param quantX Quantile della distribuzione per cui si vuole calcolare l'area fino a più infinito
...
#' @param quantX1 Quantile della distribuzione (-infinito, quantX1]

#' @param quantX2 Quantile della distribuzione [quantX2, +infinito)
...
#' @param quantX1 Quantile della distribuzione, limite inferiore dell'intervallo

#' @param quantX2 Quantile della distribuzione, limite inferiore dell'intervallo
#'
